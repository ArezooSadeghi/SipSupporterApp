...
import com.example.sipsupporterapp.view.fragment.RegisterProductFragment;

public class RegisterProductContainerActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(Context context, int customerID) {
        Intent intent = new Intent(context, RegisterProductContainerActivity.class);
